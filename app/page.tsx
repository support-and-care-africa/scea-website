      ...
      <main className="flex-1 space-y-28 pb-24 sm:space-y-32 sm:pb-32">
          ...
          <div className="mx-auto flex max-w-6xl flex-col gap-16 px-4 pb-24 pt-12 text-secondary-foreground lg:px-8 lg:pb-32 lg:pt-20">
            <div className="grid gap-10 lg:grid-cols-[1.5fr_1fr] lg:items-center">
              <div className="space-y-8">
                <div className="inline-flex items-center gap-2 rounded-full border border-primary/40 bg-primary/10 px-3 py-1 text-xs font-semibold uppercase tracking-[0.35em] text-primary">
              ...
              <div className="relative">
                <div className="absolute inset-0 rounded-[2.5rem] bg-gradient-to-br from-white/10 via-white/5 to-transparent blur-3xl" />
                <div className="relative overflow-hidden rounded-[2.25rem] border border-white/15 bg-white/10 backdrop-blur-3xl">
                  ...
                  <div className="relative space-y-8 p-8">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="rounded-full border border-white/20 px-3 py-1 text-xs text-white/70">Live</span>
                    </div>
                      ...
                      {["Momentum", "Care Index", "Collaboration", "Sustainability"].map((label, idx) => (
                        <div key={label} className="space-y-2">
                          ...
                          <div className="h-2 rounded-full bg-white/10">
                            <div
                              className="h-full rounded-full bg-gradient-to-r from-white via-accent to-primary"
                    ...
                    <div className="grid gap-3 rounded-2xl border border-white/10 bg-secondary/30 p-4 text-white/80">
              ...
              {focusAreas.map(({ icon: Icon, title, description, badge }) => (
                ...
                >
                  ...
                  <div className="relative space-y-6">
                    <div className="flex items-center justify-between">
                      <div className="inline-flex items-center gap-2 rounded-full border border-primary/30 bg-primary/10 px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.25em] text-primary">
                        {badge}
                      </div>
        ...
        <section className="relative">
          ...
          <div className="mx-auto w-full max-w-4xl px-4 py-24 text-center text-secondary-foreground lg:px-8">
            ...
            <h2 className="mt-6 text-3xl font-semibold text-white sm:text-4xl">Ready to co-create lasting change?</h2>
